...
class WordListsControllerTest < ActionController::TestCase
  ...
  test "should create word_list" do
    assert_difference('WordList.count') do
      post :create, word_list: { name: @word_list.name, type: @word_list.type, user_id: @word_list.user_id, word_id: @word_list.word_id }
    end
  ...
  test "should update word_list" do
    put :update, id: @word_list, word_list: { name: @word_list.name, type: @word_list.type, user_id: @word_list.user_id, word_id: @word_list.word_id }
    assert_redirected_to word_list_path(assigns(:word_list))
  end
